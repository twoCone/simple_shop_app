...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts() async {
    final url = Uri.parse(
        'https://my-shop-app-2a338-default-rtdb.europe-west1.firebasedatabase.app/products.json');
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    final url = Uri.parse(
        'https://my-shop-app-2a338-default-rtdb.europe-west1.firebasedatabase.app/products/$id.json');
